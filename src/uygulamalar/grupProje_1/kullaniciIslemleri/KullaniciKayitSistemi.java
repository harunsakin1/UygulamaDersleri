...
import uygulamalar.grupProje_1.Runner;
...
public class KullaniciKayitSistemi {
		...
		switch (secim) {
			...
			case 2: {
				...
				if (kullanici!=null){
					...
					System.out.println("Giriþ iptal edildi. Sepet menüsüne geri döndürülüyor");
					Runner.menu();
				}
				break;
			}
	...
	private static void kullaniciSecimMenusu(Kullanici kullanici) {
		...
		do {
			...
			System.out.println("1- Kullanýcý Arayüzünü Görüntüle");
